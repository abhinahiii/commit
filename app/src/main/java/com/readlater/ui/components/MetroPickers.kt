...
fun MetroDateTimePicker(
        ...
        Column(modifier = modifier.fillMaxWidth()) {
                        ...
                        modifier =
                                Modifier.fillMaxWidth()
                                        .border(
                                                1.dp,
                                                CommitColors.Line
                                        ) // Date is always "custom" conceptually here, but let's
                                        // keep it
                                        // simple line
                ...
                FlowRow(
                        ...
                        val customLabel =
                                if (isCustomTime)
                                        selectedTime.format(timeFormatter).lowercase(Locale.ROOT)
                                else "custom"
                        ...
                        val customBackground =
                                if (isCustomTime) CommitColors.Rust else Color.Transparent
                        val customContentColor =
                                if (isCustomTime) CommitColors.Cream else CommitColors.InkSoft
        ...
        if (showDatePicker) {
                                ...
                                buildList {
                                        ...
                                        if (thisSaturday.isAfter(tomorrow)) {
                                                add(
                                                        DateOption(
                                                                "this weekend",
                                                                listOf(thisSaturday, thisSunday)
                                                        )
                                                )
                                        }
                                        add(
                                                DateOption(
                                                        "next weekend",
                                                        listOf(nextSaturday, nextSunday)
                                                )
                                        )
                                }
                        }
                ...
                val selectedOption =
                        dateOptions.find { option -> option.dates.contains(tempSelectedDate) }
                        ...
                        Box(
                                ...
                                Column(
                                        ...
                                        MetroCalendarView(
                                                ...
                                                highlightedDates = selectedOption?.dates
                                                                ?: listOf(tempSelectedDate),
                                                minDate = deviceDate,
                ...
                val hourListState =
                        androidx.compose.foundation.lazy.rememberLazyListState(
                                initialFirstVisibleItemIndex =
                                        if (selectedHour > 2) selectedHour - 2 else 0
                        )
                val minuteListState =
                        androidx.compose.foundation.lazy.rememberLazyListState(
                                initialFirstVisibleItemIndex =
                        ...
                        Box(
                                modifier =
                                        Modifier.border(1.dp, CommitColors.Line)
                                                .clickable {
                                                        val newMonth =
                                                                currentMonth.value.minusMonths(1)
                                ...
                                Text(
                                        text = "<",
                                        style = CommitTypography.MonoTime.copy(fontSize = 16.sp),
                                        color = CommitColors.Ink
                                )
                        }
                        ...
                        Box(
                                modifier =
                                        Modifier.border(1.dp, CommitColors.Line)
                                                .clickable {
                                                        currentMonth.value =
                                                                currentMonth.value.plusMonths(1)
                                                }
                                                .padding(horizontal = 12.dp, vertical = 8.dp)
                        ) {
                                Text(
                                ...
                                week.forEach { date ->
                                        Box(modifier = Modifier.weight(1f).padding(2.dp)) {
                                                if (date != null) {
                                                        ...
                                                        val isHighlighted =
                                                                highlightedDates.contains(date)
